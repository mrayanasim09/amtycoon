    ...
    <div className="py-16">
      ...
      <section className="relative bg-gradient-to-r from-gray-900 to-gray-700 text-white py-20">
        ...
        <div className="relative container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">About AM Tycoons</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Founded in 2009 by automotive enthusiast Alex Martinez, AM Tycoons began as a small family business
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-red-100">
            Browse our inventory or visit our showroom to experience the AM Tycoons difference.
          </p>
