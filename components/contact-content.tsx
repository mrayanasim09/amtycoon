  ...
  const contactInfo = [
    {
      ...
      details: ["1234 Auto Plaza Drive", "Los Angeles, CA 90210"],
    ...
    },
    {
      icon: Phone,
      title: "Call Us",
      details: ["Sales: (213) 555-0123", "Service: (213) 555-0124"],
      action: "Call Now",
      actionUrl: "tel:+12135550123",
    },
    {
      icon: Mail,
      title: "Email Us",
      details: ["sales@amtycoons.com", "service@amtycoons.com"],
      action: "Send Email",
      actionUrl: "mailto:sales@amtycoons.com",
    },
    {
      icon: MessageCircle,
      title: "WhatsApp",
      details: ["Quick responses", "Available 9AM - 7PM"],
      action: "Chat Now",
      actionUrl: "https://wa.me/12135550123",
    },
  ]
                    ...
                    <div className="relative h-64 bg-gray-200 rounded-lg overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                        <div className="text-center text-white">
                          ...
                          <p className="font-semibold">1234 Auto Plaza Drive</p>
